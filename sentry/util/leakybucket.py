import time
def get_ms_time(): return int(time.time() * 1000)
INCR_SCRIPT = '''
local key = KEYS[1]
...
class LeakyBucket(object):
    ...
    def incr(self, key, amount=1):
        ...
        return int(self._incr_script(keys=[key], args=[amount, get_ms_time() - self.time_period, get_ms_time(), (self.time_period * 2) / 1000]))
