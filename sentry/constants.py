...
GREEN_TICK_EMOJI = f'green_tick:{GREEN_TICK_EMOJI_ID}'
RED_TICK_EMOJI = f'red_tick:{RED_TICK_EMOJI_ID}'
STAR_EMOJI = '\U00002B50'
SNOOZE_EMOJI = '\U0001f4a4'

# Mapped disco statuses to discord.py native Enums
STATUS_EMOJI = {
    discord.Status.online: ':status_online:305889169811439617',
    discord.Status.idle: ':status_away:305889079222992896',
    discord.Status.dnd: ':status_dnd:305889053255925760',
    discord.Status.offline: ':status_offline:305889028996071425',
    discord.Status.invisible: ':status_offline:305889028996071425',
    discord.ActivityType.streaming: ':status_streaming:305889126463569920',
}

INVITE_LINK_RE = re.compile(r'(discord(?:app\.com|\.com)/invite|discord\.me|discord\.gg)(?:/#)?(?:/invite)?/([a-z0-9\-]+)', re.I)
